 ...
 */
export function list(tokeniser, { parser, allowDangler, listName = "list", parent }) {
 ...
 * @param {import("../tokeniser").Tokeniser} tokeniser
 */
export function identifiers(tokeniser, parent) {
  const ids = list(tokeniser, {
    parser: Token.parser(tokeniser, "identifier"),
    listName: "identifier list",
    parent
  });
  if (!ids.length) {
 ...
 * @param {import("../tokeniser").Tokeniser} tokeniser
 */
export function argument_list(tokeniser, parent) {
  return list(tokeniser, { parser: Argument.parse, listName: "arguments list", parent });
}
 ...
 * @return {T}
 */
export function autoParenter(data) {
